...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, height: 45, backgroundColor: '#F5F5F5', borderRadius: 10, paddingHorizontal: 15, fontFamily:'Zen'  },
  locateBtn: { padding: 10 },
  arButton: { backgroundColor: '#34495E', padding: 10, borderRadius: 10, marginLeft: 10 },
  arText: { color: 'white', fontSize: 10, fontFamily:'Zen' },
  goButton: { backgroundColor: '#2ECC71', padding: 12, borderRadius: 10, marginLeft: 10 },
  goText: { color: 'white', fontFamily:'Zen'  },
  ...
  prefBtnText: { color: '#7F8C8D', fontSize: 12, fontFamily:'Zen'  },
  prefBtnTextActive: { color: '#2ECC71', fontFamily:'Zen' },
  ...
  sliderTitle: {fontFamily:'Zen'  },
  sliderTime: { color: '#2ECC71', fontFamily:'Zen'  },
  ...
  arTitle: { color: '#2ECC71', fontSize: 20, fontFamily:'Zen' , backgroundColor: 'rgba(0,0,0,0.6)', padding: 10, borderRadius: 10 },
  closeBtn: { position: 'absolute', bottom: 50, alignSelf: 'center', backgroundColor: '#E74C3C', padding: 15, borderRadius: 30 },
  closeText: { color: 'white', fontFamily:'Zen' },
  ...
  guideText: { color: 'white', fontFamily:'Zen'}
});